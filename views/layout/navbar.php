...
<nav class="navbar">
    ...
    <ul id="nav-list" class="<?php echo $showNavList === false ? 'hidden' : ''; ?>">
        ...
        <li id="featured-link"><a href="<?= $BASE_URL ?>index.php#featured-products">Feactured Products</a></li>
        <li id="categories-link"><a href="<?= $BASE_URL ?>index.php#product-categories">Categories</a></li>
